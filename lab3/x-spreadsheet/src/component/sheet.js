...
import { get_data } from '../visualization/get_data.js';
import { vis } from '../visualization/charts.js';
...
function sheetInitEvents() {
  ...
  contextMenu.itemClick = (type) => {
    ...
    } else if (type === 'insert-row' || type === 'insert-column') {
      insertDeleteRowColumn.call(this, type);
    }else if (type === 'vis'){
      const rows_data = get_data(this);
      vis(rows_data);
    }
  };
